...
async function profileImage(e) {
  ...
  saleImg.src = "https://api.mandarin.weniv.co.kr/" + result;
  const saleImgUrl = saleImg.src;
  document.querySelector(".sale-img-bg").style.backgroundImage =
    `url(${saleImgUrl})`;
}
...
async function UploadSalePost(files) {
  ...
  const imgUrl = "https://api.mandarin.weniv.co.kr/" + urlresult;
